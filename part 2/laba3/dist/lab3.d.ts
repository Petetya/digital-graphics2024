...
declare class HomeOwner implements Owner {
    private _surname;
    private _name;
    private _middleName;
    private _birth;
...
declare class SUV implements Vehicle {
    private _brand;
    private _model;
...
declare class SedanKia implements Car {
    carBodyStyle: CarBodyStyle;
    carClass: CarClass;
    brand: string;
    model: string;
...
declare class HondaShine implements Motorbike {
    motorcycleFrame: string;
    isForSport: boolean;
    brand: string;
    model: string;
...
declare class MyVehicleStorage<T extends Vehicle> implements VehicleStorage<T> {
    createdAt: Date;
    vehicles: T[];
    getVehicles(): T[];
}
declare const myVehicleStorage: MyVehicleStorage<Vehicle>;
